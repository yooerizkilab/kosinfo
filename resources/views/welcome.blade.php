...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a class="navbar-brand" href="/">MyKos</a>
  ...
  <div class="container-fluid mt-5">
    ...
    <div class="jumbotron">
      @guest
      <h1 class="display-4">Selamat Datang di MyKos</h1>
      @endguest
      ...
      <p class="lead">MyKos adalah website yang di kembangkan dengan laravel, keuntungannya adalah kita tidak harus mengintegrasikan dari awal.</p>
      <hr class="my-4">
